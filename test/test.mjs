...
import config from "../example/config.mjs";
import powtServer from "../lib/powtserver.mjs";
import protocol from "../example/common/protocol.mjs";
...
app.use("/common",express.static("../example/common"));
app.use("/test",express.static("../example/client"));
